...
def receive_packet():
    ...
    if irq_flags & IRQ_RX_DONE_MASK:
        ...
        # Decode the packet as a string, trimming leading/trailing garbage
        try:
        ...
        if '$' in packet_str:
            ...
            start_idx = packet_str.find('$')

            # Extract the data starting from the '$'
            packet_str = packet_str[start_idx+1:]  # Exclude the '$'

            # Split the data by ':'
            data_values = packet_str.split(':')
            ...
            print("Start character '$' not found in packet.")
